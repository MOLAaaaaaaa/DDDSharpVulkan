...
namespace DataCollection.DelaunayVoronoi
{
    ...
    {
        public Point3D[] Vertices { get; } = new Point3D[3];
        public Point3D Circumcenter { get; private set; }
        ...
        private void UpdateCircumcircle()
        {
            ...
            {
                var center = new Point3D(aux1 / div, aux2 / div, 0);
                Circumcenter = center;
                RadiusSquared = (center.X - p0.X) * (center.X - p0.X) + (center.Y - p0.Y) * (center.Y - p0.Y);
            }            
        }

        private bool IsCounterClockwise(Point3D point1, Point3D point2, Point3D point3)
        {
        ...
        public bool IsPointInsideCircumcircle(Point3D point)
        {
