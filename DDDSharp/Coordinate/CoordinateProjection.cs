...
namespace DataCollection.Projection
{
    //版权声明：本文为CSDN博主「hsg77」的原创文章，遵循CC 4.0 BY-SA版权协议，转载请附上原文出处链接及本声明。
    //原文链接：https://blog.csdn.net/hsg77/article/details/50200585
    ...
    public enum EnumProjectionStrip
    {
        Strip3 = 3,
        Strip6 = 6,
    }
    ...
    public abstract class ProjectionConversion2 : IProjectionConversion2
    {
        ...
        private EnumProjectionStrip m_Strip = EnumProjectionStrip.Strip3;
        ...
        public EnumProjectionStrip Strip
        {
            get
            {
                return m_Strip;
    ...
    }// public abstract class ProjectionConversion2
